package com.greencart.qa.utility;
...
public class Utils extends TestBase {
	...
	public static void getscreenshot(WebDriver driver, String testname) throws IOException {
		...
		File dest = new File("C:\\Users\\Admin\\OneDrive\\Desktop\\SS\\" + filename);
	...
	public static String getStringTestData(int row, int col) throws EncryptedDocumentException, IOException {
		...
		String value = WorkbookFactory.create(file).getSheet("Login_Credentials").getRow(row).getCell(col)
				.getStringCellValue();
		return value;
	}
